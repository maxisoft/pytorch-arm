...
ENV DEBIAN_FRONTEND=noninteractive NO_CUDA=1 NO_DISTRIBUTED=1 NO_MKLDNN=1 USE_NCCL=0 BUILD_TEST=0 USE_ZSTD=1 USE_NUMPY=1 USE_SYSTEM_NCCL=0 USE_MPI=0 USE_GLOO=0 USE_TENSORPIPE=0 USE_DISTRIBUTED=0 USE_QNNPACK=1 USE_NNPACK=0
VOLUME [ "/out" ]
WORKDIR /src/torch
